...
// would input
//        the number of units sold by each salesperson. The salesperson who sells the most units
//        wins the contest. Write a pseudocode program, then a Java application that inputs a series
//        of 10 integers and determines and prints the largest integer. Your program should use at
